class ExhibitsController < ApplicationController
  ...
  private
    ...
    def exhibit_params
      params.require(:exhibit).permit(:title, :description, digital_object_ids: [], digital_object_attributes: [:note], exhibit_digital_objects_attributes: [:id, :note, :content, :object_order, :digital_object_id, :exhibit_id, :_destroy])
    end
